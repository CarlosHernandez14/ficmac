...
const CardFases = ({color,imagen,titulo,numero,descripcion}) => {
  return (
    <div className="w-[602px] h-[311px] rounded-[20px] transform transition-transform duration-300 hover:scale-105 hover:shadow-lg " style={{ backgroundColor: color }}>
      <div className="flex justify-between">
        <div className="w-1/3 m-5">
          <img
            src={imagen}
            className="w-[169px] h-[174px] rounded-[20px]"
          />
        </div>
